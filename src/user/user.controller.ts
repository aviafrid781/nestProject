...
export class UserController {
    ...
    async createUser(@Body() createUserDto: CreateUserDto) {
        ...
        return await this.userService.createUser(createUserDto.fname, createUserDto.lname, createUserDto.email, createUserDto.password, createUserDto.number, createUserDto.address, createUserDto.userType)
